...
\t";
            ...
            if ( !(isset($context["hideElement"]) || array_key_exists("hideElement", $context) ? $context["hideElement"] : (function () { throw new RuntimeError('Variable "hideElement" does not exist.', 21, $this->source); })())) {
                ...
                echo "\"><input type=\"button\" class=\"buttons\" value=\"Show\"/></a>
\t";
            }
            // line 24
            echo "        <a href=\"";
...
\t    <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("remove_employee", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["employee"]) || array_key_exists("employee", $context) ? $context["employee"] : (function () { throw new RuntimeError('Variable "employee" does not exist.', 26, $this->source); })()), "id", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\"><input type=\"button\" class=\"buttons\" value=\"Remove\"/>
\t</a>
\t
\t</div>
</div>
...
";
    ...
    {
        return array (  118 => 32,  109 => 26,  103 => 24,  97 => 22,  95 => 21,  90 => 19,  85 => 17,  80 => 15,  77 => 14,  72 => 12,  69 => 11,  67 => 10,  63 => 9,  58 => 7,  53 => 5,  48 => 3,  45 => 2,  43 => 1,);
    }
...
\t<div id=\"showEmployeesButtons\">
\t{% if not hideElement %}
\t\t<a href=\"{{ path(\"show_one_employee\", {id: employee.id}) }}\"><input type=\"button\" class=\"buttons\" value=\"Show\"/></a>
\t{% endif %}
        <a href=\"{{ path(\"edit_employee\", {id: employee.id}) }}\"><input type=\"button\" class=\"buttons\" value=\"Edit\"/>
\t</a>
\t    <a href=\"{{ path(\"remove_employee\", {id: employee.id}) }}\"><input type=\"button\" class=\"buttons\" value=\"Remove\"/>
\t</a>
\t
\t</div>
</div>
...
{% endif %}
", "./show/template_showEmployee.html.twig", "/home/uadmin/Documentos/finalProjectDSC/templates/show/template_showEmployee.html.twig");
    }
}
